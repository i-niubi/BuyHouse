<template>
    <div>
       ...
       <swiper :options="swiperOption" ref="mySwiper" >
        ...
        <div class="details">
            <h3>详情介绍</h3>
            <div  class=" details-p" v-html="txt.morelink"></div>
            <div class="zoom" @click="nm"><span class="sf" ref="sff">展开</span><span class="fx"></span></div>
  ...
  components: {
    ...
    methods:{
        ...
        nm(){
            this.num++
            if(this.num%2==0){
                this.$refs.ssf.innerHTML="展开";
            }else{
                this.$refs.ssf.innerHTML="收起";
            }
